...
const MainNavbar = (props) => {
  ...
  useEffect(() => {
    ...
    .then((boolean) => {
      if(boolean === true) {
        ...
        //if its home page and desktop size, show only airbnb tooltip
        // if(props.isHomePage){
  ...
  return (
      ...
      <div className="mainNavbar" style={padding && {paddingLeft: padding, paddingRight: padding}}>
        <div className='mainNavbar-mobile'>
          fsdjfhksdjfl
        </div>
        <div className='mainNavbar-desktop'>
          <CustomTooltip
              open= {isTooltipWelcomeOpen}
              title= {
                  <div className="d-flex align-items-center customToolTip">
          ...
          />
              ...
              <div className='col col-lg-4 mainNavbar-middle-div'>
              ...
              <div className='col col-lg-4 col-sm-4 d-flex justify-content-end'>
                  ...
                  <a href='/become-a-host'>
                    <CustomTooltip
                      ...
                      title={
                        <div className='d-flex justify-content-center align-items-center customToolTip'>
                      ...
                      {/* <Tooltip open= {true} title="you can create new place for airbnb here"> */}
                        <div className='link-airbnbYourHome align-items-center justify-content-center'>Airbnb your home</div> 
                      {/* </Tooltip> */}
                    </CustomTooltip>
                  </a>
